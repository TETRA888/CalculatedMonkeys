...
### 5. Finally, once the x and y coordinates are calculated, you simply position the monkey in that position.
...
## Finally for my website I assigned the faces of Susan with random color values and then converted the entire mesh object into a .gltf file which could be easily utilized by programs such as OpenUSD or 3D libraries such as ThreeJS
